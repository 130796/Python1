...
class analizarLeq:
    def __init__(self, tamano, time, periodo, ruta):
    ...
    def Leq(self):
        ...
        leq=20*math.log10((1.0/self.Seconds)*(sumatoria)/(2**16))
        print("Valor Leq:")
        print leq
        print("")

class analizarRMS:
    def __init__(self, tamano,  ruta):
    ...
    def RMS(self):
        ...
        vlpico=20*math.log10(valorrms/(2**16))
        print("Valor RMS: ")
        print vlpico
        print("")
